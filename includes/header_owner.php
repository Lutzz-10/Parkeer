...
<head>
    ...
    <title><?= htmlspecialchars($judulHalaman ?? 'Owner') ?> - Parkeer</title>
    ...
    <aside id="mainSidebar" class="w-64 bg-slate-950 border-r border-slate-800 text-slate-300 flex-shrink-0 fixed inset-y-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col justify-between h-screen overflow-y-auto">
        ...
        <div>
            ...
            <div class="p-5 border-b border-slate-800 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[10px] px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-400 border border-purple-500/30 font-semibold uppercase">Executive Owner</span>
                    </div>
                </div>
            ...
            <nav class="p-4 space-y-1.5">
                <?php
                $navItems = [
                    ['url' => '/parkeer/owner/dashboard.php', 'label' => 'Dashboard', 'icon' => 'fa-chart-pie', 'match' => 'dashboard.php'],
                    ['url' => '/parkeer/owner/rekap/index.php', 'label' => 'Rekap Transaksi', 'icon' => 'fa-file-invoice-dollar', 'match' => '/rekap/'],
                ];
            ...
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2.5">
                    ...
                    <div class="truncate max-w-[110px]">
                        ...
                        <p class="text-[10px] text-purple-400 font-medium">● Owner</p>
                    </div>
                </div>
            </div>
