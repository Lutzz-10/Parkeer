...
<head>
    ...
    <title><?= htmlspecialchars($judulHalaman ?? 'Petugas') ?> - Parkeer</title>
    ...
    <aside id="mainSidebar" class="w-64 bg-slate-950 border-r border-slate-800 text-slate-300 flex-shrink-0 fixed inset-y-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col justify-between h-screen overflow-y-auto">
        ...
        <div>
            ...
            <div class="p-5 border-b border-slate-800 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-[10px] px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 font-semibold uppercase">Petugas Gate</span>
                    </div>
                </div>
            ...
            <nav class="p-4 space-y-1.5">
                <?php
                $navItems = [
                    ['url' => '/parkeer/petugas/dashboard.php', 'label' => 'Dashboard', 'icon' => 'fa-gauge-high', 'match' => 'dashboard.php'],
                    ['url' => '/parkeer/petugas/transaksi/index.php', 'label' => 'Kendaraan Parkir', 'icon' => 'fa-square-parking', 'match' => '/transaksi/index.php'],
                    ['url' => '/parkeer/petugas/transaksi/masuk.php', 'label' => 'Catat Masuk', 'icon' => 'fa-right-to-bracket', 'match' => '/transaksi/masuk.php'],
                    ['url' => '/parkeer/petugas/transaksi/riwayat.php', 'label' => 'Riwayat Transaksi', 'icon' => 'fa-clock-rotate-left', 'match' => '/transaksi/riwayat.php'],
                ];
            ...
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2.5">
                    ...
                    <div class="truncate max-w-[110px]">
                        ...
                        <p class="text-[10px] text-emerald-400 font-medium">● Petugas Aktif</p>
                    </div>
                </div>
            </div>
